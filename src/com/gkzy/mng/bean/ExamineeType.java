...
/**
 * 
 * @ClassName: ExamineeType 
 * @Description: 考生类型
 * @author 共享智汇.赵仕建 
 * @date 2017年12月27日 下午2:45:47
 */

@Entity
@Table(name = "examinee_type", catalog = "gkzy_db")
public class ExamineeType implements java.io.Serializable {
	...
	public ExamineeType(String etType) {
		this.etType = etType;
	}
	
	public ExamineeType(String etType, String gdp001, Date gdp002,
